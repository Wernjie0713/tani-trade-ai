  ...
  return (
    ...
    >
      <>
        ...
        <img alt="Rice Field" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="https://lh3.googleusercontent.com/aida-public/AB6AXuChzS8cFqhvoWQui45jpnZw_W_Us1O6lXL7CtJ-Txwz_QMhERn-Gir_t-v0VkisJzWh98lqoQJJe07OUOKAZE85qU2HnteStdbjY5UyY0nXm5dUO7jjosHaQkE5zVbb8DtEnTU6R8IO7_UtlNf9eVUJkuoxGZzEt11B_0w56XYaMMaFA21FzG4qntICVd2v6776Z_bNCqidecf_rvErHa-Cc-rszmPKa-6-coIXh9nWmqsQK8e-ssw3slmmn7nvgay1k4G0Ri8AnqY" />
        ...
        <h2 className="text-3xl font-black text-on-surface tracking-tighter">500kg - 600kg</h2>
        </div>
        <div className="text-right space-y-1">
        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-secondary">Window</p>
        <p className="font-bold text-lg text-on-surface">Late Jan 2026</p>
        </div>
        </div>
        ...
        <span className="material-symbols-outlined text-on-tertiary-fixed" data-icon="loyalty" style={{ fontVariationSettings: "'FILL' 1" }}>loyalty</span>
        </div>
        <div className="relative z-10">
        <p className="text-[10px] font-black text-on-tertiary-fixed uppercase tracking-widest">Early Incentive</p>
        <p className="text-sm font-bold text-on-tertiary-fixed-variant">10% off for reservations</p>
        </div>
        </div>
        <p className="text-on-surface-variant leading-relaxed font-medium italic">
                                    "High-quality paddy grown with organic inputs. Verified projection based on current crop health."
                                </p>
        </div>
        <div className="pt-6 border-t border-outline-variant/30 flex items-center justify-between">
        <div className="flex -space-x-2">
        <div className="w-8 h-8 rounded-full border-2 border-surface-container-lowest bg-surface-container overflow-hidden">
        <img alt="Buyer" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbkGiEXnSF5ImieUy4aDCIPn3jukS_aLTtULK2ZBBeMKtOCnRmVdNoJlIILStPjA8wcSu2e9nWwKLKHMi-zonT7QKKouzeZ99fphIZLP6RGpBQtwQ7HSZ-P_IqKaIfOWzF5VzSsT39e9pODjpzJ6c27t4syx-0o7Ocw69hEZScCEhK7tvyBVc87hwyJWnIT8_dlqUGHN8nLdbe96fskcOAVg8cdNXYYwgYh8wmAzS7C9tvW7sm8e9vL6rGcnrbc4l0pet-ad1Qm8s" />
        </div>
        <div className="w-8 h-8 rounded-full border-2 border-surface-container-lowest bg-surface-container overflow-hidden">
        <img alt="Buyer" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCcrWthGTaf7whUeAiLoye3Drnpxil8WYyZYo2qTbkBYRcrRLMdzUQxibFFRB8VdVzf46qMKi4PGaGP9l2GgmnpLycqydV3UdYX9Y-SMwgI8r7eswxp1jmiVsyiy3JlZNWjQ9BsqaS-O48UkGJhV7ABy9NHj3HYy7khFpgF7hXKo_xdevtF4gEhObEhAuIG3ZS_PyfDTUDioYDiqKYmNQBHPOwwqp71ibAaGCUpgQ6mTovSLQhgOe__LOPy4qyU6vaGUa_mWtvY9lI" />
        </div>
        ...
        <span className="text-[11px] font-bold text-primary tracking-wide">ACTIVE BUYERS WAITING</span>
        </div>
        </div>
        </div>
        </div>
        ...
        <span className="material-symbols-outlined text-on-primary" data-icon="analytics" style={{ fontVariationSettings: "'FILL' 1" }}>analytics</span>
        </div>
        <div>
        ...
        <span className="text-primary-fixed font-black text-[11px] tracking-tight">94.8% CONFIDENCE</span>
        </div>
        ...
        <p className="text-sm font-bold text-tertiary-fixed">Grade A Premium</p>
        </div>
        </div>
        <div className="relative">
        <span className="material-symbols-outlined absolute -top-2 -left-2 text-white/10 text-4xl" data-icon="format_quote">format_quote</span>
        <p className="text-sm text-white/80 leading-relaxed font-medium pl-6 pt-2 italic">
                                "Cross-referenced satellite NDVI imagery with 24 months of local moisture levels. High market readiness detected based on current regional shortfall in Premium Paddy supply."
                            </p>
        </div>
        </div>
        </section>
        ...
        <span className="material-symbols-outlined text-on-surface-variant text-[16px] mt-0.5" data-icon="info">info</span>
        ...
        <span className="material-symbols-outlined mb-1 text-[20px]" data-icon="handshake" style={{ fontVariationSettings: "'FILL' 1" }}>handshake</span>
