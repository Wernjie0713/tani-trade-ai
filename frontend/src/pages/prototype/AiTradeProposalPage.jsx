  ...
  return (
    ...
    >
      <>
        ...
        <img alt="User Profile" className="w-full h-full object-cover" data-alt="Close-up portrait of a middle-aged Malaysian farmer with a warm, friendly expression in a sunlit outdoor setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDcpWFzodPDUP1iaHfSeQNfhUbCfZulBRD0DWqDiH_o0F0G9FKT0K7YEY8XtnwT8mayLrYvvRogRc0T3gZ4aOvsGtXRT_s1x9BxnS73f5Ni1ArgmmG5QzzmNiZSI5L2DYiTXSvy8BWDfZTeMva0AKxMyJdt5cjl2yTTPbRWhsTnW8_6L23bN2_kQEnr5_S_2ViiAvpl8G4sJzivXZaDN_YzHdOczqILwQODQqmcG-w37l10d3nQuCj-nUuFi3dLgNoVKKonFrdjYwU" />
        </div>
        ...
        <span className="font-label text-primary/60 font-bold uppercase tracking-widest text-[10px]">Document No. TT-882-AI</span>
        ...
        <span className="block text-xs font-bold text-on-surface/80">14:02 PM Today</span>
        </div>
        </section>
        ...
        <span className="material-symbols-outlined text-3xl" data-icon="deployed_code">deployed_code</span>
        </div>
        <div className="space-y-0.5">
        <p className="font-label text-[10px] uppercase font-bold tracking-[0.15em] opacity-70">Supply Item</p>
        <p className="font-headline font-extrabold text-lg leading-tight">5 bags<br />Fertilizer</p>
        </div>
        </div>
        ...
        <span className="material-symbols-outlined font-bold text-2xl" data-icon="sync_alt">sync_alt</span>
        </div>
        </div>

        <div className="flex flex-col items-center text-center space-y-3 flex-1">
        <div className="w-14 h-14 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-inner">
        <span className="material-symbols-outlined text-3xl" data-icon="science">science</span>
        </div>
        <div className="space-y-0.5">
        <p className="font-label text-[10px] uppercase font-bold tracking-[0.15em] opacity-70">Acquisition</p>
        <p className="font-headline font-extrabold text-lg leading-tight">3L Organic<br />Pesticide</p>
        </div>
        </div>
        </div>
        ...
        <p className="font-label text-[11px] font-bold tracking-wide">Ratio: 1 Fertilizer = 0.6L Pesticide</p>
        </div>
        </div>
        </div>
        ...
        <span className="material-symbols-outlined text-primary text-2xl" data-icon="verified" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
        </div>
        <div className="space-y-0.5">
        <h3 className="font-headline font-bold text-on-surface text-sm">Valuation Integrity</h3>
        <p className="text-[13px] text-on-surface-variant leading-snug">Aligned with <span className="font-bold text-primary">98% of market trends</span> for current seasonal demand.</p>
        </div>
        </div>
        ...
        <span className="font-label text-[9px] text-primary uppercase font-bold">Confidence: 94%</span>
        </div>
        </div>
        <p className="text-sm font-medium italic text-on-surface/90 leading-relaxed px-1">
                                    "Analysis identifies Pak Abu's pesticide as premium organic grade. The 1:0.6 ratio compensates for the higher market value of refined liquids versus bulk solids."
                                </p>
        </div>
        ...
        <img alt="Meeting Location" className="w-full h-full object-cover" data-alt="Top down view of a modern community center pavilion surrounded by tropical greenery in Malaysia" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDbfU0ilybtE_TsNQDtT818Dj0T11F-ZFUm5CBQgqgGhlrp9wAlPgpd51-bddGyTZrROG_otFCspx9xwgfEAfYnU79LZorXIEzlGTOgLk5Fi00cVnbsJk48f1MJakwXSWDoKrWfgTGxMy0wuugmC_WhNLULJIMyxOjhBZO_gkjhkHw3Pi-S_ZFHRAIGo9Jyp5_MJuhZ56YVCYdMmtjaqeXX7H1u54if-HnhJ7A-YfR8TT_HEDxj1AgzSCNXJ0Unrh5rnOlr6oZCm8Y" />
        </div>
        <div className="flex-1">
        <h4 className="text-[10px] font-bold text-on-surface-variant/70 uppercase tracking-widest">Handover Point</h4>
        <p className="text-sm font-bold text-on-surface">Kampung Baru Center</p>
        <p className="text-[11px] text-on-surface-variant">Tomorrow • 09:00 AM</p>
        </div>
        ...
        <button className="w-full bg-primary text-on-primary py-5 rounded-full font-headline font-black text-lg shadow-xl shadow-primary/25 active:scale-[0.97] transition-all flex items-center justify-center gap-3" onClick={() => navigate(ROUTES.FARMER_TRADE_CONFIRMATION)} type="button">
