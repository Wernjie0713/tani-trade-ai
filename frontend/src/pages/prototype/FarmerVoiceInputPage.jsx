  ...
  return (
    ...
    >
      <>
        ...
        <button className="w-32 h-32 rounded-full bg-primary flex items-center justify-center text-white shadow-xl relative voice-active active:scale-95 transition-transform duration-150">
        ...
        <p className="text-sm font-medium text-on-surface leading-tight">
                        Try: <span className="text-primary italic">"I have 50kg of surplus fertilizer"</span>
        </p>
        </div>
        ...
        <button className="absolute right-2 top-2 w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center hover:bg-primary-container transition-colors shadow-sm" onClick={() => navigate(ROUTES.FARMER_PARSED_SUMMARY)} type="button">
        ...
        <button className="px-5 py-2.5 rounded-full bg-surface-container-lowest border border-primary/10 hover:border-primary/30 transition-all text-sm font-semibold text-primary shadow-sm" onClick={() => setDraftMessage("I need pesticide")} type="button">
                            “I need pesticide”
                        </button>
        <button className="px-5 py-2.5 rounded-full bg-surface-container-lowest border border-primary/10 hover:border-primary/30 transition-all text-sm font-semibold text-primary shadow-sm" onClick={() => setDraftMessage("What can I trade for seeds?")} type="button">
                            “What can I trade for seeds?”
                        </button>
        <button className="px-5 py-2.5 rounded-full bg-surface-container-lowest border border-primary/10 hover:border-primary/30 transition-all text-sm font-semibold text-primary shadow-sm" onClick={() => setDraftMessage("Planting paddy")} type="button">
                            “Planting paddy”
                        </button>
        </div>
        </section>

        <button className="w-full bg-primary text-white py-5 rounded-full font-headline font-extrabold text-xl shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-3 group" onClick={() => navigate(ROUTES.FARMER_PARSED_SUMMARY)} type="button">
        <span>Analyze &amp; Find Match</span>
