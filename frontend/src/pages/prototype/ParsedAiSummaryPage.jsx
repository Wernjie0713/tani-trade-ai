  ...
  return (
    ...
    >
      <>
        ...
        <span className="font-label text-[11px] font-bold uppercase tracking-wider text-primary">High confidence (98%)</span>
        </div>
        ...
        <span className="material-symbols-outlined text-[28px]" data-icon="potted_plant">potted_plant</span>
        </div>
        <div>
        <span className="font-label text-[10px] uppercase font-bold text-outline tracking-wider block">Crop Type</span>
        <span className="font-headline text-[17px] font-bold text-on-surface">Paddy (MR269)</span>
        </div>
        </div>
        ...
        <span className="font-headline text-base font-bold text-on-surface leading-snug">5 bags Fertilizer</span>
        </div>
        </div>
        ...
        <span className="font-headline text-base font-bold text-on-surface leading-snug">Organic Pesticide</span>
        </div>
        </div>
        </div>
        ...
        <span className="font-headline text-sm font-bold text-on-surface">Next Week</span>
        </div>
        </div>
        <div className="bg-surface-container-low/50 p-4 rounded-full flex items-center gap-3 border border-outline-variant/10">
        <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-primary shadow-sm">
        <span className="material-symbols-outlined text-[18px]" data-icon="distance">distance</span>
        </div>
        <div>
        <span className="font-label text-[10px] uppercase font-bold text-outline tracking-wider block">Radius</span>
        <span className="font-headline text-sm font-bold text-on-surface">5km</span>
        </div>
        </div>
        </div>
        ...
        <span className="font-bold text-tertiary">Market Opportunity:</span> We found <span className="text-primary font-bold">12 local traders</span> within 5km who currently need Fertilizer and have Organic Pesticide available.
                                </p>
        </div>
        </div>
        </div>
        ...
        <button className="w-full bg-primary text-on-primary py-5 rounded-full font-headline font-extrabold text-[18px] hover:opacity-95 transition-all active:scale-[0.98] shadow-lg shadow-primary/20 flex items-center justify-center gap-3" onClick={() => navigate(ROUTES.FARMER_NEARBY_MATCHES)} type="button">
